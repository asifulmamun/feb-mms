...
*/
 ...
 -->  
	 ...
	 <div class="card-panel teal lighten-2">
	   <center><b><h5><a style="color:#fff;" href="<?php echo $root_web_install; ?>wp-login.php">Click here for to Direct Login...!</a></h5></b></center>
	</div>
	<center><iframe style="width:85%;min-height:700px;" src="<?php echo $root_web_install; ?>wp-login.php"></iframe></center>
